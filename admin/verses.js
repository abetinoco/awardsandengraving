...
window.AE_CHANGELOG = [
  { date: '2026-08-19', title: 'Add and remove your own services',
    body: 'The six blocks on the Services page are yours now. Add a new service, retire one you no longer offer, drag the order around, and edit the wording, price, tags and photo on each. Tick a box to also show it on the homepage.' },
  { date: '2026-08-19', title: 'Make your own portfolio filters',
    body: 'The filter buttons on the Portfolio page — Awards, Plaques, Gifts and the rest — used to be fixed. You can now add your own, rename them and change their order. If a filter still has pictures in it, we stop you deleting it by accident.' },
  { date: '2026-08-19', title: 'Link your suppliers\u2019 catalogs',
    body: 'A new Vendors section lets you add the suppliers you order from, with their logo and a link to their catalog. Customers can browse the full range before bringing you a piece. The section stays hidden on the site until you add your first one.' },
  { date: '2026-08-19', title: 'Reset your own password',
    body: 'Forgot your password? There is now a link on the sign-in screen. It emails you a link to set a new one — no need to call us.' },
  { date: '2026-08-19', title: 'Bailey has her own login',
    body: 'Bailey can now sign in with her own email and password rather than sharing. Every change is recorded against whoever made it, so the activity log actually tells you who did what.' },
  { date: '2026-08-18', title: 'Your portfolio is yours to manage',
    body: 'Add a photo of a finished piece straight from your phone, give it a title and caption, choose which filter it sits under, and put it live. Reorder them, hide one a customer asks you to take down, and put it back later. No more emailing photos over.' },
  { date: '2026-08-18', title: 'Every photo in one place',
    body: 'A new Photo library shows every image on your website — the ones you have uploaded and the ones built in when we made the site. It tells you which are actually in use, and warns you before deleting one that is still on a page.' },
  { date: '2026-08-18', title: 'Photos shrink themselves',
    body: 'Upload a photo straight from your phone and we crop it to the right shape and shrink it for the web automatically. A 12 MB photo becomes about 90 KB, so your pages stay fast. You do not need to resize anything first.' },
  { date: '2026-08-18', title: 'The editor menu makes more sense',
    body: 'Portfolio and Reviews used to appear twice in the menu — once for the words on the page and once for the contents. Each is now one place with two tabs. There is also a View live site link so you can jump to the real website from anywhere.' },
